...
<head>
    ...
    <style>
        ...
        .btn-submit { background-color: #007bff; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer; font-size: 16px; }
    ...
    <div class="container">
        ...
        <form action="index.php?action=edit&id=<?php echo htmlspecialchars($id); ?>" method="post">
            <div class="form-group">
                ...
                <input type="text" id="nama_bunga" name="nama_bunga" value="<?php echo htmlspecialchars($bunga->nama_bunga); ?>" required>
            </div>
            <div class="form-group">
                <label for="jenis_bunga">Jenis Bunga:</label>
                <input type="text" id="jenis_bunga" name="jenis_bunga" value="<?php echo htmlspecialchars($bunga->jenis_bunga); ?>" required>
            </div>
            <div class="form-group">
                <label for="warna">Warna:</label>
                <input type="text" id="warna" name="warna" value="<?php echo htmlspecialchars($bunga->warna); ?>" required>
            </div>
